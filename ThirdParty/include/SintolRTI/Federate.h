...
#ifndef SintolRTI_Federate_h
#define SintolRTI_Federate_h
...
class SintolRTI_API Federate : public Referenced {
public:
  Federate();
  virtual ~Federate();
  ...
  /// Dimensions
  class SintolRTI_API Dimension : public Referenced {
  public:
  ...
  /// Regions
  class SintolRTI_API RegionData : public Referenced {
  public:
  ...
  struct SintolRTI_API PublishSubscribe : public Referenced {
    PublishSubscribe();
    ~PublishSubscribe();
  ...
  /// Interaction Classes
  struct SintolRTI_API Parameter : public Referenced {
    Parameter();
    ~Parameter();
  ...
  struct SintolRTI_API InteractionClass : public PublishSubscribe, public ChildInteractionClassList::Hook {
    InteractionClass();
    ~InteractionClass();
  ...
  /// Object Classes
  struct SintolRTI_API Attribute : public PublishSubscribe {
  // private:
  ...
  struct SintolRTI_API ObjectClass : public Referenced, public ChildObjectClassList::Hook {
    ObjectClass();
    ~ObjectClass();
  ...
  /// Object Instances
  struct SintolRTI_API InstanceAttribute : public Referenced {
  ...
  struct SintolRTI_API ObjectInstance : public Referenced {
  ...
  struct SintolRTI_API _Federate : public Referenced {
