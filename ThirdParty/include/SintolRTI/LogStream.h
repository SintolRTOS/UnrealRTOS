...
#ifndef SintolRTI_LogStream_H
#define SintolRTI_LogStream_H
...
#define Log(c, p) \
if (std::ostream* s = SintolRTI::LogStream::getStaticStream(SintolRTI::LogStream::c, SintolRTI::LogStream::p)) *s
