...
#ifndef SintolRTI_AbstractMessageQueue_h
#define SintolRTI_AbstractMessageQueue_h
...
class SintolRTI_LOCAL AbstractMessageQueue : public AbstractMessageReceiver {
public:
...
private:
  class SintolRTI_LOCAL MessageSender : public AbstractMessageSender {
  public:
