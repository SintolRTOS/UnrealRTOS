...
#define DECLARE_VALUE_IMPLEMENTATION(ValueImpl, ValueType)              \
  class SintolRTI_LOCAL ValueImpl : public SintolRTI::Referenced {          \
  public:                                                               \
    ValueImpl(const ValueType& value) :                                 \
      _value(value)                                                     \
    {                                                                   \
      SintolRTI::Referenced::get(this);                                   \
    }                                                                   \
                                                                        \
    static bool                                                         \
    ...
    {                                                                   \
      if (!useImplementationClass())                                    \
        return;                                                         \
      if (SintolRTI::Referenced::put(impl))                               \
        return;                                                         \
      delete impl;                                                      \
    }                                                                   \
    static void                                                         \
    ...
    {                                                                   \
      if (useImplementationClass()) {                                   \
        if (!impl) {                                                    \
          ...
          if (1 < SintolRTI::Referenced::count(impl)) {                   \
