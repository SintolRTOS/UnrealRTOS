...
#ifndef SintolRTI_Types_h
#define SintolRTI_Types_h

#include "SintolRTIConfig.h"

#include <cstdlib>
#if defined(SintolRTI_HAVE_CSTDINT)
# include <cstdint>
#elif defined(SintolRTI_HAVE_STDINT_H)
# include <stdint.h>
#elif defined(SintolRTI_HAVE_INTTYPES_H)
# include <inttypes.h>
