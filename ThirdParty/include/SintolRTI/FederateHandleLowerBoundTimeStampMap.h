...
#ifndef SintolRTI_FederateHandleLowerBoundTimeStampMap_h
#define SintolRTI_FederateHandleLowerBoundTimeStampMap_h
...
template<typename T>
class SintolRTI_LOCAL FederateHandleLowerBoundTimeStampMap {
public:
  ...
  void insert(const FederateHandle& federateHandle, const LogicalTime& logicalTime, const LogicalTime& nextMessageTime, const Unsigned& commitId, const Unsigned& beforeOwnCommitId)
  {
    ...
    SintolRTIAssert(_federateHandleCommitMap.find(federateHandle) == _federateHandleCommitMap.end());
  ...
  bool erase(const FederateHandle& federateHandle)
  {
    ...
    // SintolRTIAssert(i != _federateHandleCommitMap.end());
  ...
  std::pair<bool, bool> commit(const FederateHandle& federateHandle, const LogicalTime& logicalTime, const LowerBoundTimeStampCommitType& commitType, const Unsigned& commitId)
  {
    ...
    SintolRTIAssert(!_timeAdvanceLogicalTimeFederateCountMap.empty());
    SintolRTIAssert(!_nextMessageLogicalTimeFederateCountMap.empty());
    SintolRTIAssert(!_federateHandleCommitMap.empty());
    ...
    if (i->second._commitId != commitId) {
      SintolRTIAssert(nextMessageMode);
    ...
    SintolRTIAssert(!_nextMessageLogicalTimeFederateCountMap.empty());
    SintolRTIAssert(!_federateHandleCommitMap.empty());
    SintolRTIAssert(i->second._timeAdvanceCommit->first <= i->second._nextMessageCommit->first);
    SintolRTIAssert(_timeAdvanceLogicalTimeFederateCountMap.begin()->first <= _nextMessageLogicalTimeFederateCountMap.begin()->first);
  ...
  bool empty() const
  {
    SintolRTIAssert(_timeAdvanceLogicalTimeFederateCountMap.empty() == _federateHandleCommitMap.empty());
    SintolRTIAssert(_nextMessageLogicalTimeFederateCountMap.empty() == _federateHandleCommitMap.empty());
...
private:
  ...
  class SintolRTI_LOCAL LogicalTimeFederateCountMap {
  public:
  ...
  struct Commit {
    ...
    {
      SintolRTIAssert(_timeAdvanceCommit->first <= _nextMessageCommit->first);
    }
