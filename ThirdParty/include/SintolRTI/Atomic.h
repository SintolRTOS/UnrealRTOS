/* -*-c++-*- SintolRTI - Copyright (C) 2004-2013 Mathias Froehlich
 *
...
#ifndef SintolRTI_Atomic_h
#define SintolRTI_Atomic_h

#include "SintolRTIConfig.h"
#include "Export.h"

#if defined(SintolRTI_ATOMIC_USE_STD_ATOMIC)
# include <atomic>
#elif defined(SintolRTI_ATOMIC_USE_WIN32_INTERLOCKED)
# define SintolRTI_ATOMIC_USE_LIBRARY
#elif defined(SintolRTI_ATOMIC_USE_GCC_ASM)
# define SintolRTI_ATOMIC_USE_LIBRARY
#elif defined(SintolRTI_ATOMIC_USE_SUN)
# define SintolRTI_ATOMIC_USE_LIBRARY
#elif defined(SintolRTI_ATOMIC_USE_BSD)
# define SintolRTI_ATOMIC_USE_LIBRARY
#elif defined(SintolRTI_ATOMIC_USE_MUTEX)
# include "Mutex.h"
# include "ScopeLock.h"
#endif
...
#ifdef SintolRTI_ATOMIC_USE_STD_ATOMIC

class SintolRTI_API Atomic : public std::atomic<unsigned> {
public:
  enum MemoryOrder {
    MemoryOrderRelaxed,
    MemoryOrderConsume,
...
public:
  ...
  unsigned incFetch(MemoryOrder memoryOrder = MemoryOrderSeqCst)
  {
#if defined SintolRTI_ATOMIC_USE_LIBRARY
    return inc();
#elif defined(SintolRTI_ATOMIC_USE_GCC4_BUILTINS)
    return __sync_add_and_fetch(&_value, 1);
#elif defined(SintolRTI_ATOMIC_USE_GCC47_BUILTINS)
    return __atomic_add_fetch(&_value, 1, _toMemoryOrder(memoryOrder));
#elif defined(SintolRTI_ATOMIC_USE_MIPOSPRO_BUILTINS)
...
#if defined(SintolRTI_ATOMIC_USE_GCC47_BUILTINS)
...
#if defined(SintolRTI_ATOMIC_USE_MUTEX)
  mutable Mutex _mutex;
#endif
#if defined(SintolRTI_ATOMIC_USE_WIN32_INTERLOCKED)
