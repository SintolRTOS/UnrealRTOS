...
#ifndef SintolRTI_ServerConfigContentHandler_h
#define SintolRTI_ServerConfigContentHandler_h
...
class SintolRTI_LOCAL ServerConfigContentHandler : public XML::ContentHandler {
public:
  ...
  {
    SintolRTIAssert(index < _listenConfig.size());
