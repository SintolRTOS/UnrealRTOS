/* -*-c++-*- SintolRTI - Copyright (C) 2009-2014 Mathias Froehlich
 *
...
#ifndef SintolRTI_ServerModel_h
#define SintolRTI_ServerModel_h
...
class SintolRTI_LOCAL BroadcastConnectHandleSet {
 public:
...
class SintolRTI_LOCAL PublishSubscribe {
public:
  ...
  void removeConnect(const ConnectHandle& connectHandle)
  {
    ...
    SintolRTIAssert(!_publishedConnects.contains(connectHandle));
    // The the unsubscribe must have happened before, so just make sure that it is empty
    SintolRTIAssert(!_activeSubscribedConnects.contains(connectHandle));
    SintolRTIAssert(!_subscribedConnects.contains(connectHandle));
  }
...
class SintolRTI_LOCAL HandleEntity : public IntrusiveUnorderedMap<H, T>::Hook {
public:
...
template<typename T, typename H>
class SintolRTI_LOCAL HandleListEntity : public IntrusiveUnorderedMap<H, T>::Hook, public IntrusiveList<T, 0>::Hook {
public:
  typedef IntrusiveUnorderedMap<H, T> HandleMap;
...
class SintolRTI_LOCAL HandleStringEntity : public IntrusiveUnorderedMap<H, T>::Hook, public IntrusiveUnorderedMap<S, T>::Hook {
public:
  typedef IntrusiveUnorderedMap<H, T> HandleMap;
...
template<typename T>
class SintolRTI_LOCAL ListPair : public IntrusiveList<T, 0>::Hook, public IntrusiveList<T, 1>::Hook {
public:
  typedef IntrusiveList<T, 0> FirstList;
...
// class SintolRTI_LOCAL RegionSubscription {
// };

class SintolRTI_LOCAL Region : public HandleEntity<Region, LocalRegionHandle> {
public:
...
class SintolRTI_LOCAL InstanceAttribute : public HandleEntity<InstanceAttribute, AttributeHandle> {
public:
...
class SintolRTI_LOCAL ObjectInstanceConnect : public HandleListEntity<ObjectInstanceConnect, ConnectHandle> {
public:
...
class SintolRTI_LOCAL ObjectInstance : public HandleStringEntity<ObjectInstance, ObjectInstanceHandle>, public IntrusiveList<ObjectInstance, 0>::Hook {
public:
...
class SintolRTI_LOCAL SynchronizationFederate : public HandleListEntity<SynchronizationFederate, FederateHandle>  {
public:
...
class SintolRTI_LOCAL Synchronization : public IntrusiveUnorderedMap<std::string, Synchronization>::Hook {
public:
...
class SintolRTI_LOCAL Federate : public HandleStringEntity<Federate, FederateHandle>, public IntrusiveList<Federate, 0>::Hook, public IntrusiveList<Federate, 1>::Hook {
public:
  ...
  {
    SintolRTIAssert(federationConnect || !getIsTimeRegulating());
...
class SintolRTI_LOCAL DimensionModule : public ListPair<DimensionModule> {
public:
...
template<typename T, typename H, typename S = std::string>
class SintolRTI_LOCAL ModuleEntity : public HandleStringEntity<T, H, S> {
public:
...
class SintolRTI_LOCAL Dimension : public ModuleEntity<Dimension, DimensionHandle> {
public:
...
class SintolRTI_LOCAL UpdateRateModule : public ListPair<UpdateRateModule> {
public:
...
class SintolRTI_LOCAL UpdateRate : public ModuleEntity<UpdateRate, UpdateRateHandle> {
public:
...
class SintolRTI_LOCAL InteractionClassModule : public ListPair<InteractionClassModule> {
public:
...
class SintolRTI_LOCAL ParameterDefinitionModule : public ListPair<ParameterDefinitionModule> {
public:
...
class SintolRTI_LOCAL ClassParameter : public HandleListEntity<ClassParameter, ParameterHandle> {
public:
...
class SintolRTI_LOCAL ParameterDefinition : public HandleStringEntity<ParameterDefinition, ParameterHandle> {
public:
...
class SintolRTI_LOCAL InteractionClass : public ModuleClassEntity<InteractionClass, InteractionClassHandle>, public PublishSubscribe /*FIXME*/ {
public:
...
class SintolRTI_LOCAL ObjectClassModule : public ListPair<ObjectClassModule> {
public:
...
class SintolRTI_LOCAL AttributeDefinitionModule : public ListPair<AttributeDefinitionModule> {
public:
...
class SintolRTI_LOCAL ClassAttribute : public HandleListEntity<ClassAttribute, AttributeHandle>,
...
class SintolRTI_LOCAL AttributeDefinition : public HandleStringEntity<AttributeDefinition, AttributeHandle> {
public:
...
class SintolRTI_LOCAL ObjectClass : public ModuleClassEntity<ObjectClass, ObjectClassHandle> {
public:
...
// class SintolRTI_LOCAL ModuleInsertResult {
// public:
//   enum Type {
//     Success,
//     InconsistentFDD
...
class SintolRTI_LOCAL Module : public HandleEntity<Module, ModuleHandle> {
public:
...
class SintolRTI_LOCAL FederationConnect :
...
public:
  ...
  void insert(Federate& federate)
  { SintolRTIAssert(!federate.getFederationConnect()); _federateList.push_back(federate); federate.setFederationConnect(this); }
  void erase(Federate& federate)
  {
    if (!federate.getFederationConnect())
      return;
    SintolRTIAssert(this == federate.getFederationConnect());
...
class SintolRTI_LOCAL Federation : public HandleStringEntity<Federation, FederationHandle> {
public:
...
class SintolRTI_LOCAL NodeConnect : public IntrusiveUnorderedMap<ConnectHandle, NodeConnect>::Hook {
public:
...
public:
  ...
  bool isIdle() const;
  bool isParentConnect(const ConnectHandle& connectHandle) const
  { SintolRTIAssert(connectHandle.valid()); return _parentConnectHandle == connectHandle; }
