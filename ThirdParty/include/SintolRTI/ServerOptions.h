...
#ifndef SintolRTI_ServerOptions_h
#define SintolRTI_ServerOptions_h
...
class SintolRTI_API ServerOptions : public Referenced {
public:
  ServerOptions() :
...
public:
  ...
  // SintolRTI child servers can just continue working on its sub branch of the tree if the root
