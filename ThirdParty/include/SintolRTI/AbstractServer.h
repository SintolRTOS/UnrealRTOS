...
#ifndef SintolRTI_AbstractServer_h
#define SintolRTI_AbstractServer_h
...
class SintolRTI_API AbstractServer : public Referenced {
public:
...
protected:
  ...
  class SintolRTI_LOCAL _Operation : public Referenced {
  public:
    virtual ~_Operation();
