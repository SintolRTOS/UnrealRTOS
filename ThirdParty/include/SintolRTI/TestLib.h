/* -*-c++-*- SintolRTI - Copyright (C) 2009-2016 Mathias Froehlich
 *
...
#ifndef SintolRTI_TestLib_h
#define SintolRTI_TestLib_h
...
class SintolRTI_LOCAL ServerPool {
public:
  ServerPool()
  {
#if !defined(_WIN32)
...
private:
  class SintolRTI_LOCAL ServerThread : public Thread {
  public:
    void setupServer(const std::string& host, const SocketAddress& parentAddress, bool compress)
    {
      ...
      while (!addressList.empty()) {
        ...
        try {
          ...
          success = true;
          break;
        } catch (const SintolRTI::Exception&) {
...
public:
  ...
  class SintolRTI_LOCAL FederationBarrier : public Referenced {
  public:
  ...
  class SintolRTI_LOCAL LBTS : public Referenced {
  public:
  ...
  class SintolRTI_LOCAL Ambassador : public Referenced {
  public:
...
private:
  ...
  class SintolRTI_LOCAL AmbassadorThread : public Thread {
  public:
