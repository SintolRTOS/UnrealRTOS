...
#ifndef SintolRTI_TemplateTimeManagement_h
#define SintolRTI_TemplateTimeManagement_h
...
class SintolRTI_LOCAL TemplateTimeManagement : public TimeManagement<T> {
public:
  typedef T Traits;
  ...
  {
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || _committedOutboundLowerBoundTimeStamp <= _toLogicalTime(_outboundLowerBoundTimeStamp));
  ...
  {
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabledOrPending());
    SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnablePending());
    SintolRTIAssert(!InternalTimeManagement::getTimeAdvancePending());
    SintolRTIAssert(_logicalTime.first <= logicalTime);
    SintolRTIAssert(_logicalTimeFactory.zeroLogicalTimeInterval() <= lookahead);
    ...
    SintolRTIAssert(_timeRegulationEnableFederateHandleTimeStampMap.empty());
    SintolRTIAssert(_timeRegulationEnableFederateHandleSet.empty());
  ...
  {
    SintolRTIAssert(InternalTimeManagement::getTimeRegulationEnabled());
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnablePending());
    SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnablePending());
    SintolRTIAssert(!InternalTimeManagement::getTimeAdvancePending());
  ...
  {
    SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnabledOrPending());
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnablePending());
    SintolRTIAssert(!InternalTimeManagement::getTimeAdvancePending());
  ...
  {
    SintolRTIAssert(InternalTimeManagement::getTimeConstrainedEnabled());
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnablePending());
    SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnablePending());
    SintolRTIAssert(!InternalTimeManagement::getTimeAdvancePending());
  ...
  virtual void timeAdvanceRequest(InternalAmbassador& ambassador, const NativeLogicalTime& nativeLogicalTime, InternalTimeManagement::TimeAdvanceMode timeAdvanceMode)
  {
    ...
    LogicalTime logicalTime = _logicalTimeFactory.getLogicalTime(nativeLogicalTime);
    SintolRTIAssert(timeAdvanceMode != InternalTimeManagement::TimeAdvanceGranted);
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnablePending());
    SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnablePending());
    SintolRTIAssert(!InternalTimeManagement::getTimeAdvancePending());
    SintolRTIAssert(_logicalTime.first <= logicalTime);
    ...
    SintolRTIAssert(!_timeAdvanceToBeScheduled);
    ...
    if (InternalTimeManagement::getIsAnyAdvanceRequest()) {
      ...
      if (InternalTimeManagement::getTimeConstrainedEnabled()) {
        if (!_logicalTimeMessageListMap.empty()) {
          if (_logicalTimeMessageListMap.begin()->first.first < _pendingLogicalTime.first) {
            SintolRTIAssert(_logicalTime.first <= _logicalTimeMessageListMap.begin()->first.first);
      ...
      if (InternalTimeManagement::getTimeConstrainedEnabled() && !canAdvanceTo(LogicalTimePair(_pendingLogicalTime.first, 0))) {
        SintolRTIAssert(!_federateLowerBoundMap.empty());
        _pendingLogicalTime.first = _federateLowerBoundMap.getGALT();
        SintolRTIAssert(_pendingLogicalTime.second == 0);
      ...
      SintolRTIAssert(!"Undefined time advance mode!");
    }
  }
  ...
  virtual void modifyLookahead(InternalAmbassador& ambassador, const NativeLogicalTimeInterval& nativeLookahead)
  {
    ...
    SintolRTIAssert(!InternalTimeManagement::getTimeAdvancePending());
    SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnablePending());
    SintolRTIAssert(_logicalTimeFactory.zeroLogicalTimeInterval() <= _logicalTimeFactory.getLogicalTimeInterval(nativeLookahead));

    _targetLookahead = _logicalTimeFactory.getLogicalTimeInterval(nativeLookahead);

    SintolRTIAssert(_lastOutboundLowerBoundTimeStamp == _outboundLowerBoundTimeStamp);
    _lastOutboundLowerBoundTimeStamp = _outboundLowerBoundTimeStamp;
  ...
  void queueTimeStampedMessage(InternalAmbassador& ambassador, const LogicalTime& logicalTime, const AbstractMessage& message)
  {
    ...
    if (InternalTimeManagement::getTimeConstrainedEnabled() && canAdvanceTo(LogicalTimePair(logicalTime, 1))) {
      ...
      SintolRTIAssert(!"Received illegal timestamp order message!");
      return;
    }
  ...
  void queueTimeStampedMessage(InternalAmbassador& ambassador, const LogicalTimePair& logicalTimePair, const AbstractMessage& message)
  {
    ...
    if (InternalTimeManagement::getIsAnyNextMessageMode() && InternalTimeManagement::getTimeConstrainedEnabled()) {
      if (logicalTimePair.first < _pendingLogicalTime.first) {
        SintolRTIAssert(_timeAdvanceToBeScheduled);
        SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnabled() || _logicalTime.first <= logicalTimePair.first);
        ...
        SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnabled() || _pendingLogicalTime.first <= _logicalTimeMessageListMap.begin()->first.first);
      }
    }
  }
  ...
  void checkTimeRegulationEnabled(InternalAmbassador& ambassador)
  {
    ...
    for (typename FederateHandleTimeStampMap::const_iterator i = _timeRegulationEnableFederateHandleTimeStampMap.begin();
      ...
      SintolRTIAssert(_outboundLowerBoundTimeStamp.second == 0);
  ...
  void checkForPendingTimeAdvance(InternalAmbassador& ambassador, bool allowNextMessage = true)
  {
    ...
    if (InternalTimeManagement::getIsAnyNextMessageMode()) {
      ...
      SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnabled() || _logicalTimeMessageListMap.empty() || _pendingLogicalTime.first <= _logicalTimeMessageListMap.begin()->first.first);
      ...
      if (allowNextMessage && getIsSaveToAdvanceToNextMessage()) {
        if (canAdvanceToNextMessage(LogicalTimePair(_pendingLogicalTime.first, 0))) {
          ...
          SintolRTIAssert(!_federateLowerBoundMap.empty());
          SintolRTIAssert(_federateLowerBoundMap.getNextMessageGALT() <= _pendingLogicalTime.first);
        ...
        if (canAdvanceTo(LogicalTimePair(_pendingLogicalTime.first, 0))) {
          ...
          SintolRTIAssert(!_federateLowerBoundMap.empty());
          SintolRTIAssert(_federateLowerBoundMap.getGALT() <= _pendingLogicalTime.first);
          _sendCommitLowerBoundTimeStampIfChanged(ambassador, _federateLowerBoundMap.getGALT(), _targetLookahead, TimeAdvanceCommit);
        }
      }
    } else {
      SintolRTIAssert(InternalTimeManagement::getFlushQueueMode());
    }
  }
  ...
  void checkForPendingFlushQueue()
  {
    if (_logicalTimeMessageListMap.empty() && InternalTimeManagement::getFlushQueueMode() && _timeAdvanceToBeScheduled) {
      SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnabled() || canAdvanceTo(_pendingLogicalTime));
      _timeAdvanceToBeScheduled = false;
      SharedPtr<TimeAdvanceGrantedMessage> message = new TimeAdvanceGrantedMessage;
      queueTimeStampedMessage(_pendingLogicalTime, *message);
    }
  ...
  {
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationDisabled());
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || _committedOutboundLowerBoundTimeStamp <= _toLogicalTime(_outboundLowerBoundTimeStamp));
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || _committedOutboundLowerBoundTimeStamp <= logicalTime);
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || logicalTime <= _toLogicalTime(_outboundLowerBoundTimeStamp));
  ...
  {
    SintolRTIAssert(0 != commitType);
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationDisabled());
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || _committedOutboundLowerBoundTimeStamp <= _toLogicalTime(_outboundLowerBoundTimeStamp));
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || _committedOutboundLowerBoundTimeStamp <= _committedNextMessageLowerBoundTimeStamp);
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || _committedNextMessageLowerBoundTimeStamp <= _toLogicalTime(_outboundLowerBoundTimeStamp));
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || _committedOutboundLowerBoundTimeStamp <= logicalTime);
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || logicalTime <= _toLogicalTime(_outboundLowerBoundTimeStamp));
  ...
  void _sendCommitLowerBoundTimeStampResponse(InternalAmbassador& ambassador, const FederateHandle& federateHandle, const Unsigned& commitId)
  {
    if (!ambassador.getFederate()->getFederateHandle().valid())
      return;
    SintolRTIAssert(_federateLowerBoundMap.getFederateIsInNextMessageModeForAssert(federateHandle));
  ...
  void _setOutboundLowerTimeStampAndCurrentLookahead(const LogicalTime& logicalTime, const LogicalTimePair& lastOutboundLowerBoundTimeStamp)
  {
    ...
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || _committedOutboundLowerBoundTimeStamp <= _toLogicalTime(_outboundLowerBoundTimeStamp));
    SintolRTIAssert(_targetLookahead <= _currentLookahead);
  }

  virtual void acceptCallbackMessage(Ambassador<T>& ambassador, const TimeConstrainedEnabledMessage& message)
  {
    SintolRTIAssert(InternalTimeManagement::getTimeConstrainedEnablePending());
    SintolRTIAssert(canAdvanceTo(_pendingLogicalTime));
    SintolRTIAssert(_logicalTimeMessageListMap.empty() || _pendingLogicalTime <= _logicalTimeMessageListMap.begin()->first);
    SintolRTIAssert(!InternalTimeManagement::getTimeRegulationEnabled() || _committedOutboundLowerBoundTimeStamp <= _toLogicalTime(_outboundLowerBoundTimeStamp));
  ...
  virtual void acceptCallbackMessage(Ambassador<T>& ambassador, const TimeRegulationEnabledMessage& message)
  {
    SintolRTIAssert(InternalTimeManagement::getTimeRegulationEnablePending());
    SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnabled() || canAdvanceTo(_pendingLogicalTime));
    SintolRTIAssert(!InternalTimeManagement::getTimeConstrainedEnabled() || _logicalTimeMessageListMap.empty() || _pendingLogicalTime <= _logicalTimeMessageListMap.begin()->first);
    SintolRTIAssert(_committedOutboundLowerBoundTimeStamp <= _toLogicalTime(_outboundLowerBoundTimeStamp));
                                      ...
                                      const TimeStampedAttributeUpdateMessage& message)
  {
    ...
    LogicalTime logicalTime = _logicalTimeFactory.decodeLogicalTime(message.getTimeStamp());
    SintolRTIAssert(orderType == RECEIVE || _logicalTime <= LogicalTimePair(logicalTime, 0));
  ...
  struct SintolRTI_LOCAL _MessageListElement :
