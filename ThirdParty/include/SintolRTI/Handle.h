...
#ifndef SintolRTI_Handle_h
#define SintolRTI_Handle_h
...
class SintolRTI_LOCAL HandleName : public Handle<Type> {            \
public:                                                           \
  HandleName() {}                                                 \
  ...
  {                                                               \
    ...
    return stream.str();                                          \
                                                                  ...
                                                                  \
template<>                                                        \
struct SintolRTI_LOCAL Hash<HandleName> {                           \
...
class SintolRTI_LOCAL MessageRetractionHandle : public Handle<uint64_t> {
public:
...
template<>
struct SintolRTI_LOCAL Hash<MessageRetractionHandle> {
public:
...
class SintolRTI_LOCAL RegionHandle : public Handle<uint64_t> {
public:
  RegionHandle() {}
...
template<>
struct SintolRTI_LOCAL Hash<RegionHandle> {
public:
