...
#ifndef SintolRTI_Buffer_h
#define SintolRTI_Buffer_h

#include "VariableLengthData.h"

namespace SintolRTI {

class SintolRTI_LOCAL Buffer : public VariableLengthDataList {
  ...
  public:
    ...
    size_t chunk_size(const _byte_iterator<T>& end) const
    {
      ...
      SintolRTIAssert(_offset <= end._offset);
  ...
  protected:
    ...
    _byte_iterator& _increment(size_t offset)
    {
      ...
      // SintolRTIAssert(_offset < _listIterator->size())
      return *this;
    }
